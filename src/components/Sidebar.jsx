      ...
      <div className="h-[100vh] bg-white text-black ">
        <div className="flex justify-between items-center">
            ...
            <div className="h-[100vh]">
              <ul className="mt-12">
                <img
                  src={logo}
                  alt=""
                  className="w-24 rounded-full ml-6 my-5 -mt-5"
                />
                ...
                <li className="flex w-full justify-between text-gray-900 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-xl text-blue-600 font-semibold ml-2">
                      Upload
                    </span>
                  </div>
                </li>
          ...
          <div className="w-[85vw] border-0 border-black h-[100vh] text-gray-700">
            ...
            <div className=" flex items-center justify-center my-[27vh] mx-auto border-2 h-fit py-5 w-[30vw]">
              <Upload />
            </div>
          </div>
          {/* dashboard end */}
